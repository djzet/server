<div class="div-form">
    ...
    <form action="" method="post">
        <label for="surname"><input type="text" name="surname" placeholder="Фамилия" value="<?= $students['surname']?>"></label>
        <label for="name"><input type="text" name="name" placeholder="Имя" value="<?= $students['name']?>"></label>
        <label for="patronymic"><input type="text" name="patronymic" placeholder="Отчество" value="<?= $students['patronymic']?>"></label>
        <label for="gender"><input type="text" name="gender" placeholder="Пол" value="<?= $students['gender']?>"></label>
