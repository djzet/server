...
(1, 'Существуют 4 основные касты', 'Черные блатные, серые мужики, красные козлы, голубые опущенные');
...
INSERT INTO `rating_discipline` (`id`, `id_discipline`, `rating`, `id_student`) VALUES
(1, 1, 5, 1),
(2, 2, 5, 1),
(3, 1, 5, 2),
(4, 2, 5, 2),
